...
/**
 * Computes shortest path between two {@link Node}s in a {@link Graph}.
 */
public class Dijkstra {
	...
	/**
	 * Compute the shortest path in the given {@link Graph} from the source
	 ...
	 */
	public static List<Link> getShortestPath(Graph graph, Node source, Node target){
	 ...
	 * @param graph The {@link Graph} to initialize distances in.
	 * @param source The starting {@link Node}.
	 * @return A map of distances associated with the {@link Node}s from the {@link Graph}.
	 */
	private static Map<Node, DistanceFrom> getInitialDistances(Graph graph, Node source){
	 ...
	 */
	private static void updateSuccessorsDistances(Graph graph, Node current, Set<Node> unvisited, Map<Node, DistanceFrom> distances){
